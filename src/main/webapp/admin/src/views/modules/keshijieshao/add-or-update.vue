<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科室主任" prop="keshizhuren">
          <el-input v-model="ruleForm.keshizhuren" 
              placeholder="科室主任" clearable  :readonly="ro.keshizhuren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科室主任" prop="keshizhuren">
              <el-input v-model="ruleForm.keshizhuren" 
                placeholder="科室主任" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护士长" prop="hushizhang">
          <el-input v-model="ruleForm.hushizhang" 
              placeholder="护士长" clearable  :readonly="ro.hushizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护士长" prop="hushizhang">
              <el-input v-model="ruleForm.hushizhang" 
                placeholder="护士长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshi = true;
          ...
          if(o=='keshizhuren'){
            this.ruleForm.keshizhuren = obj[o];
	    this.ro.keshizhuren = true;
            continue;
          }
          if(o=='hushizhang'){
            this.ruleForm.hushizhang = obj[o];
	    this.ro.hushizhang = true;
            continue;
          }
          if(o=='tupian'){
	...
	this.ruleForm.keshijianjie = this.ruleForm.keshijianjie.replace(reg,'../../../ssmhz910/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `keshijieshao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.keshijieshaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
