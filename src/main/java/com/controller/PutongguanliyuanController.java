...
public class PutongguanliyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PutongguanliyuanEntity user = putongguanliyuanService.selectOne(new EntityWrapper<PutongguanliyuanEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody PutongguanliyuanEntity putongguanliyuan){
    	...
    	PutongguanliyuanEntity user = putongguanliyuanService.selectOne(new EntityWrapper<PutongguanliyuanEntity>().eq("zhanghao", putongguanliyuan.getZhanghao()));
		if(user!=null) {
